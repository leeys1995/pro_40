...
<div class="contain">
	<div class="sub-topcontent">
		<h2 class="sub-title">ホームページ総管理ページ</h2>
		 ...
		 <table>
		 <tr>
		<td><a href="hospital_modify?idx=${hosp.idx }" class="btn-write">ホームページ修正</a></td>
		<td><a href="reservation?idx=${hosp.idx }" class="btn-write">予約管理</a></td>
		<td><a href="/hospital_board/hospital_board_write?idx=${hosp.idx }" class="btn-write">お知らせを書く</a></td>
