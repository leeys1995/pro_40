				...
				<div class="nav">
					<nav>
						<ul class="navi">
							...
							<li><a href="../hospital/hospital_controller?idx=<%=idx%>">ホームページ
									<br> 管理
							</a></li>
		...
		<div class="sub-topcontent">
			...
			<div class="sub-search">
				...
				<form name="board" method="post"
					action="hospital_board?page=1&idx=<%=idx%>">
		...
		<div class="paging">
			<ul>
				<li style="padding: 0 30px;"><a href="${prev }"><img
						style="width: 30px; height: 20xpx;" src="/images/i_prev.gif"></a><a
					href="#">${page }</a> <a href="${next }"><img
						style="width: 30px; height: 20xpx;" src="/images/i_next.gif"></a></li>
