 ...
 -->
	...
	<div class="container">
		<div class="text_center">
			<p>
				<span class="support_text">${corp.c_name }は</span><br /> <strong>${corp.p_mager }</strong>
			</p>
			<span class="col_bar"></span>
		</div>
		<div class="greeting_cont">
			<img src="/resources/upload/corp/corparation_photo/${corp.c_photo }"
				alt=""
				style="float: left; padding: 0px 40px; width: 500px; height: 500px;">
			<div class="text_wrap">
				<p>${corp.c_history }</p>
				<strong class="sign">${corp.c_name } &nbsp 企業長</strong>
			</div>
		</div>
	</div>
	<!-- end contents -->
