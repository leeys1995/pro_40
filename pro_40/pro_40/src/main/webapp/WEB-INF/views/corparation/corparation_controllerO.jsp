...
<div class="contain">
	<div class="sub-topcontent">
		<h2 class="sub-title">ホームページ総管理ページ</h2>
		 ...
		 <table>
		 <tr>
		<td><a href="corparation_modify?idx=${corp.idx }" class="btn-write">ホームページ <br>修正</a></td>
		<td><a href="/corparation_board/productDirect?idx=${corp.idx }&page=1" class="btn-write">製品の問い合わせ <br> 返事する</a></td>
		<td><a href="/corparation_board/corparation_board_write?idx=${corp.idx }" class="btn-write">お知らせ 書く</a></td>
