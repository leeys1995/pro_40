...
<div class="contain">
	...
	<div class="write-form">
		<table summery="갤러리 글쓰기 테이블 입니다">
			...
			<tbody>
			<form name="input" method="post" action="corparation_modify" enctype="multipart/form-data">
			
					
					<input type="hidden" name="idx" value="${idx }">
			       <tr>    
						<th>1.기존 기업 배너</th>
						<td><img class="img2" src="/resources/upload/corp/banner/${corp.c_banner }" alt="모집사진">
						</td>
					</tr>
					<tr>    
						<th>1.기업 배너</th>
					...
					<tr>
						<th>기업이름</th>
						<td><input type="text" name="c_name" value="${corp.c_name }" readonly></td>
					</tr>
					<tr>
						<th>사업자등록</th>
						<td><input type="text" name="c_code" value="${corp.c_code }" readonly></td>
					</tr>
					<tr>
						<th>기업 전화번호</th>
					...
					<tr>
						<th>지역</th>
						<td><input type="text" name="c_addr1" value="${corp.c_addr1 }"></td>
					</tr>
					<tr>
						<th>상세주소</th>
						<td><input type="text" name="c_addr2" value="${corp.c_addr2 }"></td>
					</tr>		
					<tr>
						<th>제품소개</th>
					...
					<tr>
						<th>2.기존기업 배경사진</th>
						<td><img class="img2" src="/resources/upload/corp/corparation_photo/${corp.c_photo }" alt="모집사진">
						</td>
					</tr>	
					<tr>
						<th>2.기업 배경사진</th>
					...
					<tr>
						<th>3.기존 사진</th>
						<td><img class="img2" src="/resources/upload/corp/product_photo/${corp.p_photo }" alt="모집사진">
						</td>
